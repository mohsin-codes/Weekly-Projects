...
function ExchangeRate(){
    ...
    return (
        <section className="exchange-rate">
            <Typography.Title style={{color:"#4d4add", textAlign:"center"}} level={2}>Exchange Rate</Typography.Title>
            <Typography.Text style={{color: "#fff"}}>Get the latest exchange rate of cryptocurrencies in your favorite currency</Typography.Text>
